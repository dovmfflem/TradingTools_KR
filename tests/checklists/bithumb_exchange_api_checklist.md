...
- [ ] TWAP 주문 내역 조회: `GET /v1/twap`
  - 기본 자동화 후보
  - 기본 상태는 `progress`, limit은 100 이하
...
- [ ] TWAP 주문 요청: `POST /v1/twap`
  - 실제 주문 생성이므로 기본 자동화 금지
- [ ] TWAP 주문 취소: `DELETE /v1/twap`
  - 실제 TWAP 주문 ID 필요
...
- [ ] TWAP 주문 내역 조회를 기본 Exchange 테스트에 넣을지
